...
setGlobals 2
set -x
peer channel update -f ${TEST_NETWORK_HOME}/channel-artifacts/org3_update_in_envelope.pb -c ${CHANNEL_NAME} -o localhost:7051 --ordererTLSHostnameOverride orderer1.example.com --tls --cafile "$ORDERER_CA"
{ set +x; } 2>/dev/null
