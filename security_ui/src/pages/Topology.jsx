...
export function Topology(props) {
    ...
    const attackedNodeType = ["被攻击节点类型","attacked_node_type"]
    // const attackedNodeId = ["被攻击节点ID","attacked_node_id"]
    ...
    const [selectedAttackedNodeType,setSelectedAttackedNodeType] = useState("chainMaker")
    // const [selectedAttackedNodeId,setSelectedAttackedNodeId] = useState("")
    // 1.8 拓扑状态
    ...
    const [fabricOrdererNodes, setFabricOrdererNodes] = useState([])
    ...
    const AddNodeLogic = (nodeType, x, y, currentState) =>{
        ...
        if (nodeType === "Router") { // 进行路由节点的添加
        ...
        else if (nodeType === "FabricPeerNode") { // 进行Fabric Peer节点的添加
            setFabricPeerNodes(prevFabricPeerNodes => {
                ...
                return [...prevFabricPeerNodes, fabricPeerNodeId]
            })
            successfullyAdd = true
        }
        else if (nodeType === "FabricOrdererNode") { // 进行Fabric Orderer节点的添加
            setFabricOrdererNodes(prevFabricOrdererNodes => {
                let fabricOrdererNodeId = nodeType + "_" + (prevFabricOrdererNodes.length + 1)
                let fabricOrdererNode = {
                    id: fabricOrdererNodeId,
                    label: fabricOrdererNodeId,
                    x: x,
                    y: y,
                    size: 40,
                    img: './pictures/fabricOrdererNode.png',
                    labelCfg: {
                        position: 'bottom',
                        style: {
                            fill: '#ffffff', // 设置字体颜色
                ...
                graph.addItem('node', fabricOrdererNode);
                return [...prevFabricOrdererNodes, fabricOrdererNodeId]
            })
            successfullyAdd = true
        }
        else {
                        ...
                        <Col span={10}>
                            ...
                            >
                                ...
                                <Row>
                                    <Col span={18}>
                                        <Form.Item
                                            label={attackedNodeType[0]}
                                            name={attackedNodeType[0]}
                                            rules={[
                                                {
                                                    required: true,
                                                    message: "请选择被攻击节点类型"
                                        ...
                                        >
                                            <Select value={selectedAttackedNodeType}
                                                    onChange={(value) => setSelectedAttackedNodeType(value)}
                                                    disabled={currentAttackState}
                                            >
                                                <Select.Option value="chainMaker">ChainMaker</Select.Option>
                                                <Select.Option value="fabricPeer">Fabric Peer</Select.Option>
                                                <Select.Option value="fabricOrderer">Fabric Orderer</Select.Option>
                                            </Select>
                                        </Form.Item>
                                    </Col>
                                </Row>
                                    ...
                                    <Col span={18}>
                                        ...
                                        >
                                            <Select value={selectedAttackedNode}
                                                    onChange={(value) => setSelectedAttackedNode(value)}
                                                    disabled={currentAttackState}
                                                    options={
                                                        selectedAttackedNodeType === 'chainMaker'
                                                            ? chainMakerNodes.map((chainMakerNode) => ({
                                                                  label: chainMakerNode,
                                                                  value: chainMakerNode,
                                                              }))
                                                            : selectedAttackedNodeType === 'fabricPeer'
                                                            ? fabricPeerNodes.map((fabricPeerNode) => ({
                                                                  label: fabricPeerNode,
                                                                  value: fabricPeerNode,
                                                              }))
                                                              : selectedAttackedNodeType === 'fabricOrderer'
                                                              ? fabricOrdererNodes.map((fabricOrdererNode) => ({
                                                                    label: fabricOrdererNode,
                                                                    value: fabricOrdererNode,
                                                                }))
                                                            : [] // 默认情况返回空数组
                                                    }
                                            >
                                    ...
                                    <Col span={12}>
                                        ...
                                        >
                                            ...
                                            <Select value={selectedAttackedNode}
                                                    ...
                                                    disabled={currentAttackState}
                                                    options={fabricPeerNodes.map((fabricPeerNode) => ({
                                                        label: fabricPeerNode,
                                                        value: fabricPeerNode,
                                                    }))}
                                            >
                                            ...
                                            <Select value={selectedAttackedNode}
                                                    ...
                                                    disabled={currentAttackState}
                                                    options={fabricOrdererNodes.map((fabricOrdererNode) => ({
                                                        label: fabricOrdererNode,
                                                        value: fabricOrdererNode,
                                                    }))}
                                            >
